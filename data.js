...
export const BRANDS = {
  ...
  "topps_now": {
    ...
    "price": "$10–$30/card",
    "desc": "The most innovative product in the hobby. Topps NOW produces cards commemorating major sports moments within 24 hours of the event — on-demand, limited to what sells. If a player just threw a no-hitter, there's a card by tomorrow. Live the moment, own the moment.",
    "tags": [
      "Baseball",
      "Soccer",
      "F1",
  ...
  "motif": {
    ...
    "catLabel": "Baseball",
    "price": "$400–$800/box",
    "desc": "Design-first high-end. Motif builds every card around bold artistic patterns and gallery-style framing, then adds premium autographs. One of the newest names in the high-end lineup.",
    "tags": [
      "Baseball",
      "Art",
      "Design",
  ...
  "bowman_nba": {
    "name": "Bowman Chrome NBA Draft",
    "tier": "Mid-Tier | NBA Prospecting",
    "cat": "sport",
    "catLabel": "NBA Basketball",
    "price": "$200–$400/box",
    "desc": "The pipeline for the next generation of NBA stars. Bowman Chrome NBA Draft puts the Chrome refractor treatment on draft prospects before their professional careers begin. For the collector who wants Cooper Flagg before he plays his first NBA game.",
    "tags": [
      "NBA",
      "Basketball",
      "Draft Picks",
  ...
  "midnight": {
    ...
    "catLabel": "Baseball",
    "price": "$300–$500/box",
    "desc": "Cards for the night owls. Midnight is a dark-aesthetic limited drop built around black-and-neon design and late-night release culture. Small print runs, big style.",
    "tags": [
      "Baseball",
      "Dark Aesthetic",
      "Limited",
  ...
  "bowman_nfl": {
    "name": "Bowman Chrome NFL Draft",
    "tier": "Mid-Tier | NFL Prospecting",
    "cat": "sport",
    "catLabel": "NFL Football",
    "price": "$200–$400/box",
    "desc": "The college-to-NFL pipeline. Bowman Chrome NFL Draft features the newest draft class in their first licensed Topps cards — Chrome refractors, prospect autos, and the thrill of finding the next Patrick Mahomes before his first snap.",
    "tags": [
      "NFL",
      "Football",
      "Draft Picks",
  ...
  "royalty": {
    ...
    "catLabel": "Baseball",
    "price": "$1,000+/box",
    "desc": "Royal treatment for the game's crown jewels. Topps Royalty brings regal design, on-card autographs, and tiny print runs to the ultra high-end, the same crown that rules UFC Royalty, now for the sport's elite. One of the newest names at the top of the lineup.",
    "tags": [
      "Baseball",
      "Regal",
      "On-Card Autos",
